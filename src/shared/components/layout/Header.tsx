    ...
    <header className="sticky top-0 z-50 bg-surface border-b border-ink">
      <div className="max-w-6xl mx-auto px-6 sm:px-10 h-16 flex items-center justify-between gap-4">
        <Link href="/" className="flex items-center gap-2.5 shrink-0 select-none">
          ...
          <span className="font-display text-xl text-ink tracking-tight leading-none">
            Pic-paw
          </span>
        </Link>
        ...
        <div className="flex items-center gap-3">
          ...
          <Link
            href="/editor"
            className="inline-flex items-center gap-2 px-4 py-2 text-sm font-display tracking-tight bg-cta-bg text-cta-ink border border-ink shadow-theme hover:-translate-y-px active:translate-y-px transition-transform"
          >
